...
const services: OrcamentistaConsolidatedPreviewService[] = [
  {
    id: 'preview-service-civil-pintura-001',
    category: 'Pintura',
    discipline: civilJob.discipline,
    description: 'Pintura acrilica interna em paredes existentes',
    unit: 'm2',
    estimated_quantity: 80,
    quantity_confidence: 0.88,
    estimated_unit_cost: 38,
    estimated_total: 3040,
    cost_confidence: 0.86,
    source_agent_ids: [civilJob.output.agent_id],
    source_page_refs: civilJob.source_page_ids,
    source_evidence_refs: evidenceRefsFor(civilJob, 'svc-civil-pintura-001'),
  ...
  {
    id: 'preview-service-civil-impermeabilizacao-001',
    category: 'Civil',
    discipline: civilJob.discipline,
    description: 'Impermeabilizacao de area molhada sem evidencia vinculada',
    unit: 'm2',
    estimated_quantity: 12,
    quantity_confidence: 0.82,
    estimated_unit_cost: 95,
    estimated_total: 1140,
    cost_confidence: 0.8,
    source_agent_ids: [civilJob.output.agent_id],
    source_page_refs: [],
